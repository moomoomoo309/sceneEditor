...
local type, tonumber, assert, tostring, io, ipairs, string, table = _G.type, _G.tonumber, _G.assert, _G.tostring, _G.io, _G.ipairs, _G.string, _G.table
...
function array2d.map (f, a, arg)
    ...
    return obj(a, imap(function(row)
