...
function gooi.newSlider(params)
    ...
    function s:setCallback(callback)
        assert(type(callback) == "function", ("Function expected, got %s."):format(type(callback)))
...
---------------------------------------------------------------------------------------------
function gooi.pressed(id, xt, yt, _, isTouch)
